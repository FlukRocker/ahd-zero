...
<template>
    ...
    <div class="px-6 h-16 flex items-center justify-between border-b border-[#27272a] bg-[#09090b]">
        ...
        <div class="hidden md:flex items-center">
            ...
            <!-- Messages with Badge -->
             <Link href="#" class="px-4 py-2 rounded-lg border border-transparent hover:border-[#3f3f46] text-[#a1a1aa] hover:text-white hover:bg-[#27272a] transition-all flex items-center gap-2 relative">
        ...
        <div class="flex items-center gap-4">
             <button class="w-8 h-8 flex items-center justify-center rounded-lg border border-[#3f3f46] text-[#a1a1aa] hover:text-white hover:bg-[#27272a] transition-all">
                <i class="pi pi-bell"></i>
            </button>
             <button class="w-8 h-8 flex items-center justify-center rounded-lg border border-[#3f3f46] text-[#a1a1aa] hover:text-white hover:bg-[#27272a] transition-all">
                <i class="pi pi-cog"></i>
            </button>
            <div class="h-6 w-[1px] bg-[#3f3f46] mx-1"></div>
            <div class="flex items-center gap-3 cursor-pointer group">
                <div class="w-8 h-8 rounded-full overflow-hidden border border-[#3f3f46]">
                    <img src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/avatars/circle/avatar-m-1.png" alt="Avatar" class="w-full h-full object-cover">
                </div>
                <span class="text-sm font-medium text-[#e4e4e7] group-hover:text-white transition-colors">Robert Fox</span>
            </div>
        </div>
    </div>
</template>
